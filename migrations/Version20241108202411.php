 ...
 */
final class Version20241108202411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipment (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, brand VARCHAR(100) DEFAULT NULL, model VARCHAR(100) DEFAULT NULL, serial_number VARCHAR(100) NOT NULL, purchase_date DATE DEFAULT NULL, warranty_date DATE DEFAULT NULL, status VARCHAR(20) NOT NULL, quantity INT DEFAULT 0 NOT NULL, min_threshold INT DEFAULT 1 NOT NULL, created_at DATETIME NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_D338D583D948EE2 (serial_number), UNIQUE INDEX UNIQ_D338D583989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
